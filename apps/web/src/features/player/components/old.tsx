...
//     return (
//       <div className="bg-card/50 flex h-full w-full flex-col items-center justify-center rounded-sm border-white/10 p-8 backdrop-blur-xl">
...
//             <div className="bg-primary/20 border-primary/20 rounded-full border p-5 backdrop-blur-sm">
