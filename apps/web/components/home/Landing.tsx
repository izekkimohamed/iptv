        ...
        {favoriteChannels && favoriteChannels.length > 0 && (
          <section className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white">Favorite Channels</h2>
                <p className="text-sm text-slate-400 mt-1">Your most-watched channels</p>
              </div>
            </div>

            <div className="flex overflow-x-auto gap-4 p-4 rounded-xl border border-slate-700 bg-slate-900/30">
        ...
        {movies.filter((item) => item.playlistId === playlist?.id || 0).length > 0 && (
          <>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white">Continue Watching Movies</h2>
        ...
        {series.filter((item) => item.playlistId === playlist?.id || 0).length > 0 && (
          <>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white">Continue Watching Series</h2>
