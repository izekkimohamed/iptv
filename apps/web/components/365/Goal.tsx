  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-yellow-400/20 blur-3xl" />
        <div
          className="absolute top-1/2 left-1/2 h-48 w-48 -translate-x-1/2 -translate-y-1/2 animate-ping rounded-full bg-yellow-400/10 blur-2xl"
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="relative">
          <div
            className="absolute inset-0 animate-ping rounded-full bg-yellow-400/30"
            style={{ animationDuration: '1.5s' }}
          />
          <div className="relative rounded-full bg-linear-to-br from-yellow-400 to-yellow-600 p-4 shadow-2xl shadow-yellow-500/50">
            <Trophy
        ...
        {/* Goal Badge */}
        <div className="animate-bounce rounded-full bg-linear-to-rrom-yellow-400 via-yellow-500 to-yellow-400 bg-size-[200%_100%] px-6 py-2 shadow-2xl shadow-yellow-500/50">
          <div className="animate-[shimmer_2s_infinite] bg-linear-to-r from-transparent via-white/30 to-transparent bg-size-[200%_100%] bg-clip-text">
            <span className="text-sm font-black tracking-[0.3em] text-black uppercase">
              ⚽ Goal Scored!
            </span>
          </div>
        </div>
        ...
        {/* Score Display */}
        <div className="flex w-full max-w-sm items-center justify-between gap-6 rounded-2xl border border-yellow-400/30 bg-linear-to-br from-yellow-400/10 to-transparent p-6 backdrop-blur-sm">
          {/* Home Team */}
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              <div className="absolute -inset-2 animate-pulse rounded-full bg-yellow-400/20 blur-md" />
              <img
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-2 rounded-full bg-yellow-400/20 px-3 py-1">
              <div className="h-1.5 w-1.5 animate-pulse rounded-full bg-yellow-400" />
              <span className="text-[10px] font-black tracking-wide text-yellow-400 uppercase">
                {game.gameTime}' Min
              </span>
            </div>
          </div>
