  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-neutral-950/5 backdrop-blur-md transition-all duration-500">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-white/10 bg-neutral-950/50 shadow-2xl shadow-black/80">
        {/* Decorative Top Glow */}
        <div className="absolute top-0 right-0 left-0 h-1 bg-linear-to-r from-transparent via-primary to-transparent opacity-50" />
        ...
        <div className="space-y-10 p-10">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="relative">
              ...
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full border-2 border-primary/30 bg-neutral-800 text-primary shadow-[0_0_40px_-10px_rgba(var(--primary),0.4)]">
          ...
          <div className="space-y-4">
            ...
            <div className="h-4 w-full overflow-hidden rounded-full border border-white/5 bg-neutral-950">
              <div
                className="relative h-full bg-linear-to-r from-primary to-primary-foreground/50 shadow-[0_0_20px_rgba(var(--primary),0.5)] transition-all duration-500 ease-out"
