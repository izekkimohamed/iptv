...
export const categories = pgTable(
  ...
  (table) => ({
    ...
    playlistTypeIdx: index('playlist_type_idx').on(table.playlistId, table.type),
    uniqueCategoryPerPlaylist: uniqueIndex('unique_category_per_playlist').on(table.categoryId, table.playlistId),
  }),
);
...
export const movies = pgTable(
  ...
  (table) => ({
    ...
    uniqueMovies: uniqueIndex('unique_movies').on(table.streamId, table.categoryId, table.playlistId),
  }),
);
...
export const series = pgTable(
  ...
  (table) => ({
    ...
    uniqueseries: uniqueIndex('unique_series').on(table.seriesId, table.categoryId, table.playlistId),
  }),
);
